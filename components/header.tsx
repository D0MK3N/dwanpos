  ...
  return (
    <motion.header
      ...
      className={cn(
        ...
        isScrolled ? 'bg-blue-600/90 backdrop-blur-md shadow-md' : 'bg-transparent'
      )}
    >
          ...
          <nav className="hidden md:flex items-center space-x-8">
            {navItems.map((item, index) => (
              <motion.button
                ...
                className={cn(
                  'cursor-pointer transition-colors relative group font-semibold tracking-wide',
                  isActiveItem(item)
                    ? 'text-white drop-shadow-md' // highlight active
                  ...
                  <div className="pt-4">
                    {mounted && (
                      (() => {
                        ...
                        if (user) {
                          return (
                            <RainbowButton className="w-full" onClick={() => { setIsOpen(false); router.push('/dashboard'); }}>
                              Dashboard
                            </RainbowButton>
                          );
                        }
                        ...
                        return (
                          <RainbowButton className="w-full" onClick={() => { setIsOpen(false); router.push('/login'); }}>
                            Login
                          </RainbowButton>
                        );
                      })()
